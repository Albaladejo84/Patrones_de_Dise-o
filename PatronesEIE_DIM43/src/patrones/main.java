...
// Creo el agregado/colección que contiene los datos a cargar
		patrones.comportamiento.iterador.Lista miLista = new patrones.comportamiento.iterador.ListaTarjetas(misTarjetas);
// Creo el iterador que permite recorrer la colección con los datos cargados
		patrones.comportamiento.iterador.Iterador miIterador = miLista.getIterador();
		
// Recorro la colección con los datos cargados usando el iterador apropiado
	...
	private static void probarProxy() {
		...
		try {
			...
			System.out.println("La excepción capturada es:" + e.getMessage());
		}
...
/*		Otra forma de hacerlo: 
	...
	*/	
	...
	private static void probarBuilderVCR() {
		...
		System.out.println("UME Básico con " + VCRUME_Basico.toString());
		...
		System.out.println("Marina Básico con " + VCRMarina_Basico.toString());
	...
	private static void probarFactoryMethod (TipoPago formaDePagar) {
		Pago miPago = FactoriaPagos.pagar(formaDePagar);
		miPago.hacerPago(); // <----------
...
//		miPago.hacerPago(); // <----------
	...
	private static void probarAbstractFactory () {
		...
		FactoriaAbstracta miFactoriaDeMetodosPago = ProveedorDeFactorias.getFactoriaConcreta("Método de pago");
		MetodoPago miMetodoDePago = (PagoCredito) miFactoriaDeMetodosPago.create("CREDITO");
		
		System.out.println ("Una tarjeta de tipo: " + miTarjeta.getMarcaTarjeta() + " y método de pago: " + miMetodoDePago.hacerPago());
